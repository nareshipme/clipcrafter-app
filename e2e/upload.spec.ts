...
base.describe("Feature: Upload Flow – unauthenticated", () => {
  base.describe("Scenario: Upload API requires authentication", () => {
    base(
      "Given no auth token, When POST /api/projects/proj_1/upload is called, Then it returns 401",
      async ({ request }) => {
    ...
    base(
      "Given no auth token, When POST /api/projects/create is called, Then it returns 401",
      async ({ request }) => {
...
authTest.describe("Feature: Upload Flow – authenticated", () => {
  authTest.describe("Scenario: Upload modal is accessible", () => {
    ...
    authTest(
      "Given authenticated user, When POST /api/projects/create is mocked, Then no real Inngest job is triggered",
      async ({ page }) => {
